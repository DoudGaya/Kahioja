            ...
            <div class="py-3 px-1">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="grid grid-cols-2 text-left md:flex md:flex-row card-reviews my-2">
                        ...
                        <div class="card-curr-price" v-if="(productdeliveryfee != 0)">₦{{ parseFloat(productdeliveryfee).toLocaleString() }}</div>
                        <div class="card-curr-price" v-else>Free Delivery</div>
                    </div>
                </div>
            </div>
        </a>
