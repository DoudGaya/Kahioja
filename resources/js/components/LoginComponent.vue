<template>
    <div v-show="displayLogin" id="login" class="shadow">
        <div id="login-content">
            ...
            <div id="login-body" class="py-6 text-center px-16">
                <div>
                ...
                <div v-show="displayLoginForm">
                    ...
                    <div class="my-4">
                        <div>
                            <input class="border border-gray-300 rounded py-2 px-6 w-full my-2 focus:outline-none" type="text" name="email" id="email" placeholder="Email Address">
                        </div>
                        <div>
                ...
                <div v-show="displaySignUpForm">
                    ...
                    <div class="my-4">
                        <div>
                            <input class="border border-gray-300 rounded py-2 px-6 w-full my-2 focus:outline-none" type="text" name="name" id="name" placeholder="Full Name">
                        </div>
                        <div>
                            <input class="border border-gray-300 rounded py-2 px-6 w-full my-2 focus:outline-none" type="text" name="email" id="email" placeholder="Email Address">
                        </div>
