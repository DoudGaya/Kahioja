<template>
    <div id="category-nav" class="grid grid-cols-2 gap-4">
        <div class="flex justify-between">
            <!-- Categories  -->
            <button @click="categoryBtn()" class="flex justify-between items-center">
        ...
        <div class="flex justify-end">
            <button class="flex justify-between items-center border w-1/2" style="background-color:#ffffff;">
        ...
        <div v-show="displayStore" id="store-btn" class="text-black top-20 bg-white shadow-md w-1/6 p-4">
            <ul>
                <div :key="store.id" v-for="store in stores" class="flex justify-between border-b py-2 items-center">
                    <span><li class="text-sm">{{ store.shop_name }}</li></span>
                </div>
            </ul>
        </div>
    </div>
