<template>
    <div class="px-4 md:px-14 mt-20 mb-8 relative top-36 md:top-0">
        <div class="grid md:grid-cols-4 grid-cols-2 gap-6">
            <div :key="productIndex.name" v-for="productIndex in productsToShow" class=""> 
                    ...
                    <a :href="`/item/${products[productIndex].slug}`">
                        ...
                        <div class="py-3">
                            ...
                            <div class="grid grid-cols-2 text-left md:flex md:flex-row card-reviews my-2">
                                ...
                                &nbsp;<div>{{ products[productIndex].ship_fee != null ? `N${products[productIndex].ship_fee}` : 'Free Delivery'}}</div>
                            </div>
                            <div class="grid grid-cols-2 text-left md:flex md:flex-row card-reviews my-2">
