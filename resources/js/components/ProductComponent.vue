<template>
    <div class="bg-white rounded-lg px-4">
        <img class="mx-auto py-4" :src="productphoto" :alt="productdescription">
        <!-- Product Details  -->
        <div class="py-3">
            <h1 class="card-title">{{ productname }}</h1>
            <div class="flex items-center">
                <span class="card-curr-price"><b>{{ currprice }}</b></span>
                <span class="card-prev-price"><b>{{ prevprice }}</b></span>
            </div>
            <div class="flex items-center">
                <div class="flex mr-4">
                ...
                <div class="card-reviews">{{ reviews }} Reviews</div>
            </div>
            <span class="flex card-curr-price">
