    ...
    <div>
        <div class="md:grid md:grid-cols-2 gap-12">
            ...
            <div class="hidden md:block">
                ...
                <div class="my-6 py-4 px-16 rounded-lg yus-shadow">
                    <div class="my-4 text-2xl font-extrabold">Delivery time</div>
                    <p class="my-4">
                        Orders are delivered on all days (Monday - Sunday) excluding public holidays
                    </p>
                </div>
            </div>
        </div>
...
export default {
    ...
    data(){
        return{
            ...
            checkOutName: window.authUser.name,
            checkOutAddress: window.authUser.address,
            checkOutCity: window.authUser.city,
            checkOutState: window.authUser.state,
            checkOutPhone: window.authUser.phone
        }
    },
    computed: {
        getAllCart(){ 
