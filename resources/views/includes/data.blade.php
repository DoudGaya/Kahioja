                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="grid grid-cols-2 text-left md:flex md:flex-row card-reviews my-2">
                        ...
                        @if($product->ship_fee != 0 || $product->ship_fee != null)
                            <div class="card-curr-price">₦{{ number_format((($product->ship_fee * 0.15) + $product->ship_fee), 2, '.', ',') }}</div>
                        @else
                            <div class="card-curr-price">Free Delivery</div>
                        @endif
                    </div>
                </div>
