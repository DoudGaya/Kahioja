...
@section('main')
    <!-- Banner -->
    <div id="banner" class="slider relative top-36 lg:top-0 mt-64 lg:mt-6 hidden md:block">
            ...
            @foreach($categories as $category)
                <div>
                    <a href="{{ route('front.category', $category->slug) }}">
                        <div class="cate-yus rounded-full border-8 lg:border-24">
    ...
    <!-- Main Category -->
    <div id="main-cat" class="relative top-36 lg:top-0 lg:px-14 px-4 my-8 text-center hidden md:block">
    ...
    <!-- Best Product  -->
    <div id="best-product" class="relative top-36 lg:top-0 lg:px-14 px-4 my-8">
    ...
    <!-- Top Rated -->
    <div id="top-product" class="relative top-36 lg:top-0 lg:px-14 px-4 mt-20 mb-8">
    ...
    <!-- Banner 2 -->
    <div id="banner2" class="relative top-36 lg:top-0 mt-16">
        <div class="flex items-center">
            <img class="mx-auto" src="{{ asset('images/banner-2.jpg') }}" alt="banner 2">
        </div>
    </div>
    <!-- Hot Products -->
    <div id="hot-product" class="relative top-36 lg:top-0 lg:px-14 px-4 mt-20 mb-8">
    ...
    <!-- Banner 3 -->
    <div id="banner3" class="relative top-36 lg:top-0 mt-16">
        <div class="flex items-center">
    ...
    <!-- Trust  -->
    <div class="relative top-36 lg:top-0 mt-16 lg:px-14 px-4">
        <div class="grid lg:grid-cols-4 md:grid-cols-3 grid-cols-2 gap-6">
