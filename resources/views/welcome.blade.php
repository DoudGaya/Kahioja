...
@section('main')
    ...
    <!-- Top Rated -->
    <div id="top-product" class="relative top-36 md:top-0 md:px-14 px-4 mt-20 mb-8">
    ...
    <!-- Banner 2 -->
    <div id="banner2" class="relative top-36 md:top-0 mt-16">
        <div class="flex items-center">
            <img class="mx-auto" src="{{ asset('images/banner-2.jpg') }}" alt="banner 2">
        </div>
    </div>
    <!-- Hot Products -->
    <div id="hot-product" class="relative top-36 md:top-0 md:px-14 px-4 mt-20 mb-8">
    ...
    <!-- Banner 3 -->
    <div id="banner3" class="relative top-36 md:top-0 mt-16">
        <div class="flex items-center">
