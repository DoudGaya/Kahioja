    ...
    <div id="banner" class="mt-6 px-14">
        ...
        <div id="product-details" class="grid grid-cols-5 gap-6 my-10">
            ...
            <div class="col-span-2 w-full border rounded-xl shadow">
                <img class="w-4/5 mx-auto py-6" src="{{ asset('images/products/'.$productt->photo) }}" alt="">
            </div>
            <!-- Product Details  -->
            <div class="rounded-xl px-10 py-8 border col-span-2 shadow">
                <div class="py-3">
                    <h1 class="product-details-title">{{ $productt->name }}</h1>
                    <div class="flex items-center">
                        <span class="product-curr-price"><b>{{ $productt->showPrice() }}</b></span>
                        <span class="product-prev-price"><b>{{ $productt->showPreviousPrice() }}</b></span>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-6 my-7">
                        ...
                        <div>
                            <button style="background-color:#ff9400;" class="mx-auto btn-yus rounded-full w-full flex flex-row justify-center items-center py-2 text-white">
                                <div class="card-bag-label">
                                    Buy Now 
                                </div>
                                <div class="ml-2">
